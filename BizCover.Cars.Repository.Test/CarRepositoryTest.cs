...
namespace BizCover.Cars.Repository.Test;

[Serializable, ImmutableObject(true)] public sealed partial class CarRepositoryTest
{
    #region Tests
    ...
    /// 
    /// </summary>
    [Test] public void AddCarToRepositoryForApproval()
    {
    ...
    /// 
    /// </summary>
    [Test] public void GetCarsFromRepositoryForApproval()
    {
        var directory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Content");
    ...
    /// 
    /// </summary>
    [Test] public void UpdateCarFromRepositoryForApproval()
    {
        var directory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Content");
