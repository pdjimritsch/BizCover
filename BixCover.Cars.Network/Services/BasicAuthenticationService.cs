...
namespace BizCover.Cars.Network.Services;
using Abstraction;
using ServiceModels;
...
public sealed partial class BasicAuthenticationService : IBasicAuthenticationService
{
    ...
    public BasicAuthenticationService(
        IServiceProvider? provider, IContextConfiguration? configuration, 
        IHttpCommunication? communicator = null, ILogger? logger = null) : base()
    {
        _provider = provider;
