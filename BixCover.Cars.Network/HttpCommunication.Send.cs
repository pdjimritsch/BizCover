...
{
    #region IHttpCommunication Members - Send
    ...
    /// <returns></returns>
    public async Task<TResponse?> SendAsync<TResponse>(string? url, HttpMethod method, object? component, ApiRequestHeader? requestHeader, ApiResponseHeader? responseHeader = null, CancellationToken? cancellationToken = null)
    {
        ...
        var clientRequest = new HttpRequestMessage(method, url);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public async Task<TResponse?> SendAsync<TResponse>(Uri? uri, HttpMethod method, object? component, ApiRequestHeader? requestHeader, ApiResponseHeader? responseHeader = null, CancellationToken? cancellationToken = null)
    {
        TResponse? response = default;
        ...
        var clientRequest = new HttpRequestMessage(method, uri.AbsolutePath);
