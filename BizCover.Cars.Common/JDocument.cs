                ...
                if ((document_node.Value != null) && (document_node.Value.GetValueKind() == JsonValueKind.Object))
                {
                    ...
                    if ((node != null) && (node.GetValueKind() == JsonValueKind.Object))
                    {
                        foreach(var kv in node.AsObject())
                        {
                            ...
                            {
                                var attribute = TypeHelper.GetAttribute<JsonPropertyNameAttribute>(property);
                                ...
                                if ((attribute != null) && !string.IsNullOrEmpty(attribute.Name))
                                {
                                        ...
                                        if (components != null)
                                        {
                                            ...
                                            foreach (var component in components)
                                            {
                                                ...
                                                foreach (var kvv in kv.Value.AsObject())
                                                {
                                                    ...
                                                    {
                                                        var vattribute = TypeHelper.GetAttribute<JsonPropertyNameAttribute>(vproperty);

                                                        if ((vattribute != null) && (vattribute.Name != null) &&
                                                            vattribute.Name.Equals(kvv.Key, StringComparison.OrdinalIgnoreCase))
                                                        {
                                    ...
                                    else if ((kv.Value != null) && kv.Value.GetPropertyName().Equals(attribute.Name))
                                    {
                                                ...
                                                !(component.GetType().IsArray || component.GetType().IsSZArray) && !component.GetType().IsGenericType)
                                            {
                                                ...
                                                foreach (var kvv in kv.Value.AsObject())
                                                {
                                                    foreach (var vproperty in vproperties)
                                                    {
                                                        ...
                                                        if ((vattribute != null) && !string.IsNullOrEmpty(vattribute.Name) &&
                                                            vattribute.Name.Equals(kvv.Key, StringComparison.OrdinalIgnoreCase))
                                                        {
                                                            SetNodeProperty(kvv.Value, component, vproperty);
                                                        }
                                                    ...
                                                    foreach (var kvr in jarr)
                                                    {
                                                            ...
                                                            (kvr != null))
                                                        {
                                                            ...
                                                            foreach (var kvn in kvr.AsObject())
                                                            {
                                                                ...
                                                                {
                                                                    var vattribute = TypeHelper.GetAttribute<JsonPropertyNameAttribute>(entryProperty);

                                                                    if ((vattribute != null) && !string.IsNullOrEmpty(vattribute.Name))
                                                                    {
                                                                        if (kvn.Key.Trim().Equals(vattribute.Name.Trim(), StringComparison.OrdinalIgnoreCase))
                                                                        {
                ...
                else if ((document_node.Value != null) && (document_node.Value.GetValueKind() == JsonValueKind.Number))
                {
                    ...
                    if (properties != null && properties.Length > 0)
                    {
                        foreach (var property in properties)
                        {
                            ...
                            if ((attribute != null) && !string.IsNullOrEmpty(attribute.Name))
                            {
                                if (document_node.Value.GetPropertyName().Equals(attribute.Name))
                                {
                        ...
                        foreach (var node in arr)
                        {
                            if ((node != null) && (node.AsObject() != null) && (properties != null)) 
                            {
                                foreach (var kvv in node.AsObject())
                                {
                                    foreach (var property in properties)
                                    {
                                        JsonPropertyNameAttribute? attribute = default;

                                        if (property != null)
                                        {
                                            attribute = TypeHelper.GetAttribute<JsonPropertyNameAttribute>(property);
                                        }

                                        if ((attribute != null) && 
                                            (property != null) && (attribute.Name?.Equals(kvv.Key) ?? false))
                                        {
            ...
            for (int pos = 0; pos < count; ++pos)
            {
                ...
                if (!string.IsNullOrEmpty(document_node.Key))
                {
                    foreach (var property in properties)
                    {
                        ...
                        {
                            var vattribute = TypeHelper.GetAttribute<JsonPropertyNameAttribute>(property);

                            if ((vattribute != null) && !string.IsNullOrEmpty(vattribute.Name))
                            {
                                if (vattribute.Name.Equals(document_node.Key, StringComparison.OrdinalIgnoreCase))
                                {
            ...
            if (jarr != null && jarr.Length > 0)
            {
                ...
                foreach (var jnode in jarr)
                {
                    ...
                    foreach (var property in properties)
                    {
                        ...
                        if ((vattribute != null) && !string.IsNullOrEmpty(vattribute.Name))
                        {
                            if (vattribute.Name.Equals(jnode.Key, StringComparison.OrdinalIgnoreCase))
                            {
