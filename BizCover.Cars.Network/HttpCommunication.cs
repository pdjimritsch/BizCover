...
public sealed partial class HttpCommunication : IHttpCommunication
{
    ...
    /// 
    /// </summary>
    public IErrorLogger? ErrorLogger { get; set; } = null!;
    ...
    public static void SetRequestHeaders(HttpRequestMessage? message, ApiRequestHeader? header)
    {
        ...
        if ((header != null) && 
            (header.Headers?.CacheControl?.MaxAge.HasValue ?? false) && 
            (message.Headers?.CacheControl?.MaxAge != null))
        {
        ...
        if ((header != null) && (header.Headers?.Connection != null) && 
            (message.Headers?.Connection != null))
        {
            header.Headers.Connection.CopyTo([.. message.Headers.Connection], 0);
        }

        if ((header != null) && (header.Headers?.Expect != null) && 
            (message.Headers?.Expect != null))
        {
            header.Headers.Expect.CopyTo([.. message.Headers.Expect], 0);
        }

        if ((header != null) && (header.Headers?.IfMatch != null) && 
            (message.Headers?.IfMatch != null))
        {
            header.Headers.IfMatch.CopyTo([.. message.Headers.IfMatch], 0);
        }

        if ((header != null) && (header.Headers?.IfNoneMatch != null) && 
            (message.Headers?.IfNoneMatch != null))
        {
            header.Headers.IfNoneMatch.CopyTo([.. message.Headers.IfNoneMatch], 0);
        }

        if ((header != null) && (header.Headers?.Pragma != null) && 
            (message.Headers?.Pragma != null))
        {
            header.Headers?.Pragma.CopyTo([.. message.Headers.Pragma], 0);
        }

        if ((header != null) && (header.Headers?.ProxyAuthorization != null) && 
            (message.Headers?.ProxyAuthorization != null))
        {
            message.Headers.ProxyAuthorization = header.Headers.ProxyAuthorization;
        }

        if ((header != null) && (header.Headers?.Range != null) && 
            (message.Headers?.Range != null))
        {
            message.Headers.Range = header.Headers.Range;
        }

        if ((header != null) && (header.Headers?.Referrer != null) && 
            (message.Headers?.Referrer != null))
        {
            message.Headers.Referrer = header.Headers.Referrer;
        }

        if ((header != null) && (header.Headers?.TE != null) && 
            (message.Headers?.TE != null))
        {
            header.Headers.TE.CopyTo([.. message.Headers.TE], 0);
        }

        if ((header != null) && (header.Headers?.Trailer != null) && 
            (message.Headers?.Trailer != null))
        {
            header.Headers.Trailer.CopyTo([.. message.Headers.Trailer], 0);
        }

        if ((header != null) && (header.Headers?.TransferEncoding != null) && 
            (message.Headers?.TransferEncoding != null))
        {
            header.Headers.TransferEncoding.CopyTo([.. message.Headers.TransferEncoding], 0);
        }

        if ((header != null) && (header.Headers?.Upgrade != null) && 
            (message.Headers?.Upgrade != null))
        {
            header.Headers.Upgrade.CopyTo([.. message.Headers.Upgrade], 0);
        }

        if ((header != null) && (header.Headers?.Via != null) && (message.Headers?.Via != null))
        {
            header.Headers.Via.CopyTo([.. message.Headers.Via], 0);
        }

        if ((header != null) && (header.Headers?.Warning != null) && (message.Headers?.Warning != null))
        {
