/**
 * https://medium.com/@tapan_mishra/how-to-converting-sql-rank-over-partition-to-linq-or-alternative-2ab6e78ba6b4
...
using BizCover.Cars.Data.Factory.Enumerations;
using BizCover.Cars.Data.Factory.Helpers;
...
partial class VaultContext
{
    ...
    public async Task<bool> AddAsync<T, A>(T? entry) where T : class, A, IEquatable<A>, IDataPrimaryKey
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) &&
            (await ContainerContext.AddAsync<Car, ICar, VaultContext>(Cars, entry as Car, _logger)))
        {
        ...
        where T : class, A, IEquatable<A>, IDataPrimaryKey
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (collection != null) &&
            (await ContainerContext.AddRangeAsync<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger)))
        {
    ...
    public bool BulkDelete<T, A>(IEnumerable<T> collection) where T : class, A, IEquatable<A>, IDataPrimaryKey
    {
        if (ContainerContext.IsTypeReference<T, Car>() && (Context != null) &&
            ContainerContext.BulkDelete<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger))
        {
        ...
        where T : class, A, IEquatable<A>, IDataPrimaryKey
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null) &&
            (await ContainerContext.BulkDeleteAsync<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger)))
        {
    ...
    {
        if (ContainerContext.IsTypeReference<T, Car>() && (Context != null) &&
            ContainerContext.BulkInsert<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger))
        {
    ...
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null) &&
            (await ContainerContext.BulkInsertAsync<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger)))
        {
    ...
    {
        if (ContainerContext.IsTypeReference<T, Car>() && (Context != null) &&
            ContainerContext.BulkInsertOrUpdate<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger))
        {
            return (Context.SaveChanges() > 0);
        }
    ...
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null) &&
            (await ContainerContext.BulkInsertOrUpdateAsync<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger)))
        {
            var changes = await Context.SaveChangesAsync();
    ...
    {
        if (ContainerContext.IsTypeReference<T, Car>() && (Context != null) &&
            ContainerContext.BulkInsertOrUpdateOrDelete<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger))
        {
            return (Context.SaveChanges() > 0);
        }
    ...
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null) &&
            (await ContainerContext.BulkInsertOrUpdateOrDeleteAsync<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger)))
        {
            var changes = await Context.SaveChangesAsync();
    ...
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null) &&
            (await ContainerContext.DeleteAsync<Car, ICar, VaultContext>(Cars, entry as Car, _logger)))
        {
            var changes = await Context.SaveChangesAsync();
    ...
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null) &&
            (await ContainerContext.DeleteRangeAsync<Car, ICar, VaultContext>(Cars, collection.Cast<Car>(), _logger)))
        {
            var changes = await Context.SaveChangesAsync();
        ...
        where T : class, A, IEquatable<A>, IDataPrimaryKey
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null))
        {
            var component = await ContainerContext.RemoveAsync<Car, ICar, VaultContext>(Cars, entry as Car, _logger);
    ...
    public async Task<bool> UpdateAsync<T, A>(T? entry) where T : class, A, IEquatable<A>, IDataPrimaryKey
    {
        if ((await ContainerContext.IsTypeReferenceAsync<T, Car>()) && (Context != null))
        {
            if (await ContainerContext.UpdateAsync<Car, ICar, VaultContext>(Cars, entry as Car, _logger))
            {
